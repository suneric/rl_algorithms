...
<img src="https://github.com/suneric/rl_algorithms/blob/main/references/rl_algorithms.svg" width=80% height=80% align="center">
...
$$\mathbb{L}_{i}(\theta_{i}) = \mathbb{E}_{s,a,r,s' \sim \rho(.)}[(y_i - Q(s,a;\theta_i))^2]$$
where
