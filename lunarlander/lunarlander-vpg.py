...
if __name__ == '__main__':
    ...
    buffer = ReplayBuffer(obs_dim,act_dim,capacity=10000,gamma=0.99,lamda=0.97)
    agent = VPG(obs_dim,act_dim,hidden_sizes=[400,400],pi_lr=3e-4,q_lr=1e-3,target_kld=0.01)
