...
from .core import Actor, TwinCritic, copy_network_variables
...
"""
class SAC:
    def __init__(self,obs_dim,act_dim,hidden_sizes,act_limit,gamma,polyak,pi_lr,q_lr,alpha_lr,noise_obj):
        self.pi = Actor(obs_dim,act_dim,hidden_sizes,'relu',act_limit)
        self.tq = TwinCritic(obs_dim,act_dim,hidden_sizes,'relu')
        self.ac_target = deepcopy(self.tq)
        self.log_alpha =
